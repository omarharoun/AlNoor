...
pub fn render(req: wisp.Request, ctx: Context) -> wisp.Response {
  ...
  let markdown_element =
    markdown_utils.load_markdown_with_fallback("priv/guidelines", ctx.locale)
  ...
  layout.docs_layout(
    ...
    layout.article_page_meta(
      g_(i18n_ctx, "Community Guidelines"),
      g_(i18n_ctx, "Read the Fluxer Community Guidelines"),
    ),
    g_(i18n_ctx, "Fluxer Community Guidelines"),
    content,
  )
